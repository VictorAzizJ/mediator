  ...
  return (
    <div className="min-h-screen flex" style={{ backgroundColor: 'var(--background)' }}>
      ...
      <div className="flex-1 min-w-0 p-8 overflow-y-auto">
        <div className="max-w-[100rem] mx-auto w-full min-w-0 px-2">
          <h1 className="text-3xl font-bold mb-10" style={{ color: 'var(--foreground)' }}>
            Reports Dashboard
          </h1>
          ...
          {/* Average Score Cards */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10 [&>*]:min-w-0">
            <AverageScoreCard
              title="Sentiment"
